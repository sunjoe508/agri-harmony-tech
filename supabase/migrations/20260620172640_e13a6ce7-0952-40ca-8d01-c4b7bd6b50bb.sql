...
BEGIN
  FOR d IN SELECT * FROM jsonb_array_elements(demos) LOOP
    ...
    -- profile (handle_new_user trigger may not have fired since we bypass; ensure row)
    ...
    -- 24h of readings, hourly, for each sensor
    FOR i IN 0..23 LOOP
